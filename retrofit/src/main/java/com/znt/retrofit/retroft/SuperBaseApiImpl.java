 ...
 * 描述:     TODO
 */
public class SuperBaseApiImpl implements SuperBaseApi {
    ...
    public SuperBaseApiImpl(String baseUrl) {
...
//        if (retrofit == null) {
//            //锁定代码块
//            synchronized (SuperBaseApiImpl.class) {
//                if (retrofit == null) {
